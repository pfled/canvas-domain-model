...
public class Exam : ISubmittable<List<string>>
{
    ...
    public Exam(string title, string description, DateTime deadline, bool isSubmitted, Course course, List<string> questionsList)
    {
        Title = title;
